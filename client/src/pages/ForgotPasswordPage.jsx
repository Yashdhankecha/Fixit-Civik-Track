        ...
        <div className="relative z-10 w-full max-w-6xl flex items-center justify-center gap-8">
          ...
          >
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 text-lg mb-2">Secure Reset</h3>
              <p className="text-gray-600 text-sm">Your password reset is protected with enterprise-grade security measures.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 text-lg mb-2">Quick Delivery</h3>
              <p className="text-gray-600 text-sm">Reset instructions are sent instantly to your verified email address.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 text-lg mb-2">Easy Recovery</h3>
              <p className="text-gray-600 text-sm">Get back to fixing your community issues in just a few simple steps.</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="w-full bg-white/80 backdrop-blur-sm border border-gray-200 text-gray-700 py-3 px-6 rounded-xl font-medium shadow-sm hover:shadow-md transition-all duration-200"
              >
                Send Another Email
              </button>
            </motion.div>
